		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cadastro de Parceiros 11",
									"targetURL": "#bpmaint0011bpmaint11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpmaint0011bpmaint11-display": {
								"semanticObject": "bpmaint0011bpmaint11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmaint0011.bpmaint11",
									"url": sap.ui.require.toUrl("bpmaint0011/bpmaint11")
								}
							}
						}
					}
